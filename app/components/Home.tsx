  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-24 left-16 text-4xl"
      >
        🚀
      </motion.div>
      ...
      <motion.div
        ...
        className="relative z-10 backdrop-blur-3xl bg-white/10 border border-white/20 rounded-[40px] px-12 py-16 shadow-[0_0_60px_rgba(0,255,255,0.3)] text-center max-w-5xl"
      >
        <motion.div
          animate={{
            rotate: [0, 10, -10, 0],
        ...
        <motion.h1
          ...
          transition={{ duration: 1 }}
          className="text-7xl font-black leading-tight bg-gradient-to-r from-cyan-400 via-white to-pink-500 bg-clip-text text-transparent"
        >
          Pon Mystica Fathima
        </motion.h1>
