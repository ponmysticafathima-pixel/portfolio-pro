    ...
    >
      ...
      <div className="relative w-full max-w-5xl mx-4 flex items-center justify-center">
        ...
        <motion.div
          ...
          className="relative z-10 backdrop-blur-3xl bg-white/10 border border-white/20 rounded-[40px] px-6 py-10 sm:px-8 sm:py-12 md:px-12 md:py-16 shadow-[0_0_60px_rgba(0,255,255,0.3)] text-center w-full"
        >
          <motion.div
